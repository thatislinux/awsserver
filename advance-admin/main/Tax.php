    ...
    <div id="wrapper">
                     ...
                     <li>
                        <a href="#"><i class="fa fa-yelp "></i>Invoice<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
							<?php //TODO Add the Invoice Parameter here <?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><i class="icon-table"></i> Tax</h1>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
            <?php 
            include('../connect.php');
                $result = $db->prepare("SELECT * FROM tax ORDER BY id DESC");
                $result->execute();
            ...
            Total Number of Tax:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
            </div>
</div>


<!--<input type="text" style="height:35px; color:#222;" name="filter" value="" id="filter" placeholder="Search tax..." autocomplete="off" />-->
<a rel="facebox" href="addtax.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Tax</button></a><br><br>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
    <thead>
        <tr>
		<?php //TODO Add the table borders <?>
            <th width="50%"> Tax </th>
    ...
    <tbody>
            ...
            <td>
            <a href="deletetax.php" id="<?php echo $row['id']; ?>" class="delbutton" title="Click to Delete the Category"><button class="btn btn-danger"><i class="">Delete</i></button></a></td>
            </tr>
            <?php
                }
            ?>
