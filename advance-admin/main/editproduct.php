...
<span>Category : </span>
<select name="category" style="width:260px; height:30px; margin-left:-5px;" >
...
<span>Description : </span><textarea style="width:265px; height:50px;" name="name" ><?php echo $row['product_name']; ?> </textarea><br>
...
<!--<span>Quantity: </span><input type="hidden" style="width:265px; height:30px;" min="0" name="sold" value="<?php echo $row['qty_sold']; ?>" /><br>-->
