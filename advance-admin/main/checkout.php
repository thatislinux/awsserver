...
<input type="hidden" name="date" value="<?php echo date("m/d/yyy"); ?>" />
<input type="hidden" name="invoice" value="<?php echo $_GET['invoice']; ?>" />
<?php
//printf("invoice in checkout is %s", $_GET['invoice']);
?>
...
?><button class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Save & Download PDF</button>
