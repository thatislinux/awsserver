    ...
    <div id="wrapper">
                    ...
                    <li>
                        <a href="#"  class="active-menu-top"><i class="fa fa-desktop "></i>Master <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
							...
							<li>
                                <a href="Umo.php"><i class="fa fa-code "></i>Umo</a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><i class="icon-table"></i> UMO</h1>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
            <?php 
            include('../connect.php');
                $result = $db->prepare("SELECT * FROM umo ORDER BY id DESC");
                $result->execute();
            ...
            Total Number of UMO:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
            </div>
</div>


<!--<input type="text" style="height:35px; color:#222;" name="filter" value="" id="filter" placeholder="Search tax..." autocomplete="off" />-->
<a rel="facebox" href="addumo.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Umo</button></a><br><br>
