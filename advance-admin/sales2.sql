...
--
-- Table structure for table `Umo`
--

CREATE TABLE IF NOT EXISTS `umo` (
  `id` int(11) NOT NULL,
...
INSERT INTO `umo` (`id`, `unit`) VALUES
(1, 'no'),
(2, 'kg');
-- --------------------------------------------------------
...
) ENGINE=sales AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sales`
--

INSERT INTO `sales` (`transaction_id`, `invoice_number`, `cashier`, `date`, `type`, `amount`, `profit`, `due_date`, `cname`, `name`, `address`, `balance`) VALUES
(0, 'RS-0262328', 'Admin', '02/08/18', 'cash', '150', '85', '200', 'ram','', 'cbe', ''),
(1, 'RS-233323', 'Admin', '02/08/18', 'cash', '13650', '7735', '14000', 'rama', '', 'cbe', '');
...
INSERT INTO `sales_order` (`transaction_id`, `invoice`, `product`, `qty`, `tax`, `amount`, `profit`, `product_code`, `gen_name`, `name`,`customer_name`, `address`,`unit`, `price`, `discount`, `date`) VALUES
(1, 'RS-0262328', '1', '1', '5', '150', '85', 'RBH-f881', 'Drinks', 'Coke', 'sudhar' , 'cbe' ,'' , '150', '', '02/08/18'),
(2, 'RS-233323', '1', '91', '18', '13650', '7735', 'RBH-f881', 'Drinks', 'Coke ', 'sudhar' , 'cbe' ,'' , '150', '', '02/08/18'),
(3, 'RS-0233302', '1', '1', '15', '150', '85', 'RBH-f881', 'Drinks', 'Coke ', 'sudhar' , 'cbe' ,'' , '150', '', '02/12/18'),
(4, 'RS-86033', '1', '1', '12', '150', '85', 'RBH-f881', 'Drinks', 'Coke ', 'sudhar' , 'cbe' ,'' , '150', '', '02/13/18'),
(5, 'RS-86033', '1', '1', '18', '150', '85', 'RBH-f881', 'Drinks', 'Coke ', 'sudhar' , 'cbe' ,'' , '150', '', '02/13/18'),
(6, 'RS-23332024', '1', '1', '18', '150', '85', 'RBH-f881', 'Drinks', 'Coke ', 'sudhar' , 'cbe' ,'' , '150', '', '02/25/18');
