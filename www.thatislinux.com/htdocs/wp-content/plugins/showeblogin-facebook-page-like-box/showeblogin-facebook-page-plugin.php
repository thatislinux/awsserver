 ...
 * Copyright (C) 2016  Suresh Prasad  (email : spsmiter@gmail.com)
...
class ShowebloginFacebookPagePlugin extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        ...
        <?php  if ( $title ) {  ?> <h2 class="widget-title"><?php echo $title; ?></h2> <?php }  ?>
            <div id="fb-root"></div><script>(function(d, s, id) {  var js, fjs = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) return;  js = d.createElement(s); js.id = id;  js.src = "//connect.facebook.net/<?php echo $language; ?>/sdk.js#xfbml=1&version=v2.8&appId=214112425590307";
  fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'facebook-jssdk'));</script>			
			<div class="fb-page" data-href="<?php echo $url; ?>" data-tabs="<?php echo $tabs; ?>" data-small-header="<?php echo $data_small_header; ?>" data-adapt-container-width="<?php echo $data_adapt_container_width; ?>" data-hide-cta="<?php echo $data_hide_cta; ?>" data-hide-cover="<?php echo $data_hide_cover; ?>" data-show-facepile="<?php echo $show_faces; ?>" data-width="<?php echo $width; ?>" data-height="<?php echo $height; ?>"><div class="fb-xfbml-parse-ignore"><blockquote cite="<?php echo $url; ?>"><a href="http://www.superwebtricks.com/">SuperWebTricks</a> Loading...</blockquote></div></div>         
